# Pager.w -- Pager widget class
# Author: Bert Bos <bert@let.rug.nl>
# Copyright: see README file
# 3 Dec 1992 - 20 Dec 1993
# Version: 1.2

@class XfwfPager (XfwfBoard)  @file=Pager
...
@ The |foreground| color is the color the text is drawn in. By default,
this widget uses black letters on a white background.

        @var Color foreground = <String> "black"
 
@ The |background| resource is therefore given the default |"white"|,
instead of the usual |XtDefaultBackground|, since that is not guaranteed
to produce white.
